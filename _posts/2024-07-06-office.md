...
published: true
tags: [writeup, HTB, Hard, Joomla, PasswordReuse, Wireshark, pcap, Forensics, Kerbrute, UserEnumeration, Cracking, Hashes, hashcat, Registry, Macro, LibreOffice, MSSQL, SharpEfsPotato, Kerberos, RID, SMB, Windows]
---
